...
interface DialogProps {
  ...
  children?: (({ closeModal, openModal }: { closeModal: () => void; openModal: () => void }) => React.ReactNode) | null
  title: string
  modalContent: ({ closeModal, openModal }: { closeModal: () => void; openModal: () => void }) => React.ReactNode
}
